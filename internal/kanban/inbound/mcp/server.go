...
func (s *Server) registerAllTools() {
	...
	s.addTool("update_task",
		...
		map[string]interface{}{
			...
			"human_estimate_seconds":  map[string]interface{}{"type": "integer", "description": "Agent-provided estimate of how long the task should take, in seconds"},
		},
	...
	s.addTool("reorder_task",
		...
		map[string]interface{}{
			"project_id": map[string]interface{}{"type": "string", "description": "The project ID"},
			"task_id":    map[string]interface{}{"type": "string", "description": "The task ID to reorder"},
			"position":   map[string]interface{}{"type": "integer", "description": "The new 0-based position within the column"},
		},
