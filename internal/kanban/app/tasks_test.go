...
func TestApp_CreateTask_Success(t *testing.T) {
	...
	task, err := a.CreateTask(ctx, projectID, "Test Task", "Test summary", "Task description", domain.PriorityMedium, "architect", "agent1", "", nil, nil, "")
...
func TestApp_CreateTask_EmptyTitle_ReturnsError(t *testing.T) {
	...
	_, err := a.CreateTask(ctx, projectID, "", "Summary", "Description", domain.PriorityMedium, "architect", "agent1", "", nil, nil, "")
...
func TestApp_CreateTask_EmptySummary_ReturnsError(t *testing.T) {
	...
	_, err := a.CreateTask(ctx, projectID, "Test Task", "", "Description", domain.PriorityMedium, "architect", "agent1", "", nil, nil, "")
...
func TestApp_CreateTask_ProjectNotFound_ReturnsError(t *testing.T) {
	...
	_, err := a.CreateTask(ctx, projectID, "Test Task", "Summary", "Description", domain.PriorityMedium, "architect", "agent1", "", nil, nil, "")
